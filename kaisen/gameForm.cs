    ...
    public partial class gameForm : Form
    {
        ...
        public void createMap()
        {
            ...
            for (int i = 0; i < sizeXmap; i++)
            {
                for (int j = 0; j < sizeYmap; j++)
                {
                    ...
                    {
                        myMap[i, j].Text = Alphabet[j ].ToString();
                        myMap[i, j].Enabled = false;
                        enemyMap[i, j].Text = Alphabet[j ].ToString();
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            if (msec.ToString().Length == 1)
                label2.Text = "0" + msec.ToString();
            else
                label2.Text = msec.ToString();
